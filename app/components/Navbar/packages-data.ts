...
export const packagesData: PackageCategory[] = [
  {
    ...
    items: [
      { title: "Char Dham Yatra", href: "/spiritual-yatra/uttarakhand-char-dham-yatra" },
      { title: "Panch Prayag", href: "/spiritual-yatra/panch-prayag-darshan" },
      { title: "Char Dham by Helicopter", href: "/chardham/badrinath-heli" },
      { title: "Do Dham Yatra ", href: "/spiritual-yatra/do-dham" },
      // { title: "Do Dham ", href: "/spiritual-yatra/do-dham" },
      { title: "Panch Kedar Yatra", href: "/spiritual-yatra/panch-kedar-yatra-12-days" },
