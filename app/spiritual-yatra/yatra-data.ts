...
export const SPIRITUAL_YATRA_PACKAGES: SpiritualYatraPackage[] = [
 ...
 {
  slug: "panch-kedar-yatra-12-days",
  heading: "Grand Panch Kedar Yatra (12 Days).",
  imgSrc: "/images/aboutus/Panch-Kedar-Yatra.png",
  paragraph:
    "The ultimate spiritual odyssey. Journey through the high-altitude meadows and ancient stone temples of the five Kedars: Kedarnath, Madhyamaheshwar, Tungnath, Rudranath, and Kalpeshwar.",
  price: "₹63,000 / Person", // Adjusted for 12 days
  bestTime: "May to June, September to October",
  route: "Haridwar ⇄ Haridwar",
  inclusions: ["meals", "stay", "transport", "guide"],
  exclusions: ["porter or pony charges", "personal trekking gear", "personal expenses", "insurance"],
  itinerary: [
    { title: "Day 1: Haridwar to Guptkashi", details: "A scenic 200km drive along the Ganga and Alaknanda rivers. Overnight stay in Guptkashi." },
    { title: "Day 2: Guptkashi to Kedarnath", details: "Drive to Sonprayag/Gaurikund and start the 16km trek to Kedarnath (1st Kedar). Attend the evening Aarti." },
    { title: "Day 3: Kedarnath to Guptkashi", details: "Early morning Darshan at the temple, then trek back down to Gaurikund. Drive back to Guptkashi for rest." },
    { title: "Day 4: Guptkashi to Ransi", details: "Drive to Ransi village, the starting point for the Madhyamaheshwar trek. A short, easy day to prepare for the climb." },
    { title: "Day 5: Ransi to Madhyamaheshwar", details: "A 16km steady uphill trek to Madhyamaheshwar (2nd Kedar). Witness the stunning Chaukhamba peaks." },
    { title: "Day 6: Madhyamaheshwar to Ransi/Ukhimath", details: "Trek back to Ransi and drive to Ukhimath, the winter seat of Kedarnath. Rest your muscles." },
    { title: "Day 7: Ukhimath to Chopta & Tungnath", details: "Drive to Chopta. Trek 3.5km to Tungnath (3rd Kedar - Highest Shiva Temple) and Chandrashila Peak. Return to Chopta." },
    { title: "Day 8: Chopta to Sagar Village / Mandal", details: "Drive toward Sagar Village, the gateway to the toughest trek of the circuit: Rudranath." },
    { title: "Day 9: Sagar Village to Rudranath", details: "An 18km strenuous trek through the beautiful Pitradhar ridge to reach Rudranath (4th Kedar). Unique face-worship of Shiva." },
    { title: "Day 10: Rudranath to Mandal", details: "Trek back down to Mandal/Sagar. This descent is long and requires careful footing through the rhododendron forests." },
    { title: "Day 11: Mandal to Kalpeshwar & Pipalkoti", details: "Drive to Helang and then to Kalpeshwar (5th Kedar). This temple is accessible by a short walk. Drive to Pipalkoti." },
    { title: "Day 12: Pipalkoti to Haridwar", details: "The final leg of the journey. Drive back to Haridwar via Rishikesh, completing the sacred circuit." },
  ],
},
  {
