...
const monsoonTreks = getTreksBySeason('rainy')
  ...
  return (
    <div className="py-20">
      <div className="mx-auto max-w-7xl px-4">
        ...
        {/* Heading */}
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-[#1A2B49] mb-4 text-center">
            Monsoon Treks
          </h1>
          ...
          {monsoonTreks.map((t) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl font-bold text-[#1A2B49] mb-2">
                  {t.name}
                </h3>
