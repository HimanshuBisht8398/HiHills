          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                ...
                <p className="mt-2 text-lg font-semibold text-white">{trek.days}</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                <p className="text-xs uppercase tracking-[0.2em] text-slate-300">Altitude</p>
                <p className="mt-2 text-lg font-semibold text-white">{trek.altitude}</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                <p className="text-xs uppercase tracking-[0.2em] text-slate-300">Best Time</p>
                <p className="mt-2 text-lg font-semibold text-white">{trek.bestTime}</p>
              </div>
            </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Your complete trek flow from arrival to departure.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-slate-100">
              <h2 className="text-xl font-bold text-slate-900">Quick Trek Info</h2>
